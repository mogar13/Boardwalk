...
at `2xl` it is ~1100px and the same table must not huddle in the middle of it. **The direction ring
is now DRAWN** — a faint circle, 15rem, centred on the piles — because four arrows alone are four
specks on a felt this size, and because concentricity is then something a player can see rather than
something the arithmetic promises. **The active-colour pill is gone**: it said RED under a red card
