 ...
 * match. The answer here is the referee. See `plans/done/LIARS_DICE.md`.
 *
 ...
 * lives with. Variable table size has no seam yet; `plans/done/LIARS_DICE.md` records it as open.
 *
