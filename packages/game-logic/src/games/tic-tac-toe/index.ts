/**
 * `tic-tac-toe`'s rulebook, as the package's public subpath: `@boardwalk/game-logic/games/tic-tac-toe`.
 *
 ...
 * the way it did when this file was `src/games/tic-tac-toe/logic/ticTacToe.ts`.
 */
export * from './logic/ticTacToe';
